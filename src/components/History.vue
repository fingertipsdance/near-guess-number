		  ...
		  if (res.Ok != null) {
			  res.Ok.forEach((record,index) => {
				  ...
				  this.data.push({
					  ...
					  created: new Date(record.created/1000000).toLocaleDateString().replace(/\//g, "-") + " " + new Date(record.created/1000000).toTimeString().substr(0, 8),
